    ...
    <div class="container min-h-dvh relative overflow-hidden py-8 px-6 dark:text-white dark:bg-color1">
        ...
        <form id="loginForm" class="relative z-10">
            <div class="bg-white py-8 px-6 rounded-xl mt-12 dark:bg-color10">
                <div class="flex justify-between items-center">
                    <a href="sign-in.php" class="text-center text-xl font-semibold text-p2 border-b-2 pb-2 border-p2 w-full dark:text-p1 dark:border-p1">Sign In</a>
                    <a href="sign-up.php" class="text-center text-xl font-semibold text-bgColor18 border-b-2 pb-2 border-bgColor18 w-full dark:text-color18 dark:border-color18">Sign Up</a>
                </div>
                ...
                <div class="pt-8">
                    ...
                    <div class="flex justify-between items-center py-3 px-4 border border-color21 rounded-xl dark:border-color18 gap-3">
                        <input type="tel" id="mobile" name="mobile" placeholder="Enter Mobile Number" maxlength="10" pattern="[0-9]{10}"
        ...
        <div class="relative z-10">
            <p class="text-sm font-semibold text-center pt-5">
                Don’t have an account? <a href="sign-up.php" class="text-p2 dark:text-p1">Sign Up</a> here
            </p>
        </div>
    </div>
